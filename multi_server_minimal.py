...
def load_configuration(config_path="config-minimal.json") -> dict:
...
def main():
    ...
    logging.info("==============================================")
    logging.info("Avvio del Server MCP Nexus MINIMAL in corso...")
    logging.info("==============================================")
    ...
    server_instance = FastMCP("NexusServer-Minimal")
    ...
    logging.info("----------------------------------------------")
    logging.info("Server Nexus MINIMAL pronto e configurato")
    logging.info("----------------------------------------------")
